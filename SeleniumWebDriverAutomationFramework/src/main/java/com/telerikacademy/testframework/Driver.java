...
public class Driver implements WebDriver {
    ...
    public Driver(WebDriver driver) {
        webDriver = driver;
        Duration timeout = Duration.ofSeconds(Integer.parseInt(getConfigPropertyByKey("config.default.timeout.seconds")));
    ...
    public TargetLocator switchTo() {
        LOGGER.info("Switching to Target locator...");
